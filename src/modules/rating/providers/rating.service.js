...
var RatingService = /** @class */ (function () {
    function RatingService(mapper, protocolServerService, contextFactory, logger) {
        this.mapper = mapper;
        this.protocolServerService = protocolServerService;
        this.contextFactory = contextFactory;
        this.logger = logger;
    }
    RatingService.prototype.rating = function (requestPayload) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        context = this.contextFactory.create(protocol_context_dto_1.ProtocolContextAction.RATING, requestPayload.context.domain);
                        ...
                        return [4 /*yield*/, this.protocolServerService.executeAction(api_config_1.becknUrl.rating, payload)];
                    case 1:
                        result = _a.sent();
