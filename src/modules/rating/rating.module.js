...
var rating_service_1 = require("./providers/rating.service");
var rating_mapper_1 = require("./mapper/rating.mapper");
...
var RatingModule = /** @class */ (function () {
    ...
    RatingModule = __decorate([
        (0, common_1.Module)({
            ...
            providers: [rating_service_1.RatingService, rating_mapper_1.RatingMapper, protocol_server_provider_1.ProtocolServerService, context_factory_provider_1.ContextFactory, uuid_factory_provider_1.UuidFactory, common_1.Logger]
        })
    ], RatingModule);
    return RatingModule;
}());
