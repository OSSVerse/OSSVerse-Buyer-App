...
var SupportService = /** @class */ (function () {
    function SupportService(mapper, protocolServerService, contextFactory, logger) {
        this.mapper = mapper;
        this.protocolServerService = protocolServerService;
        this.contextFactory = contextFactory;
        this.logger = logger;
    }
    SupportService.prototype.support = function (requestPayload) {
        return __awaiter(this, void 0, void 0, function () {
            var context, payload, result, mappedResult, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        context = this.contextFactory.create(protocol_context_dto_1.ProtocolContextAction.SUPPORT, requestPayload.context.domain);
                        ...
                        return [4 /*yield*/, this.protocolServerService.executeAction(api_config_1.becknUrl.support, payload)];
                    case 1:
                        result = _a.sent();
                    ...
                    case 2:
                        error_1 = _a.sent();
                        this.logger.error("error executing support call", error_1);
                        throw error_1;
